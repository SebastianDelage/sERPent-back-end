...
class SalesReportServiceTest {
    ...
    void shouldMapDailySalesProjectionToResponse() {
        ...
        SalesDailyProjection row = new SalesDailyProjection() {
            @Override
            ...
            public BigDecimal getTotalRevenue() {
                return new BigDecimal("9100.0000");
            }
        };
    ...
    void shouldMapSalesSummaryProjectionAndNormalizeAverageTicketScale() {
        ...
        SalesSummaryProjection row = new SalesSummaryProjection() {
            @Override
            public Long getTransactions() {
                return 3L;
            }
            ...
            public BigDecimal getAverageTicket() {
                return new BigDecimal("33.33333");
            }
        };
