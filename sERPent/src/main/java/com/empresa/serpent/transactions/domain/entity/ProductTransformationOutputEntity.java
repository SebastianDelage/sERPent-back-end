...
@Builder
@Entity
@Table(name = "product_transformation_outputs")
public class ProductTransformationOutputEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "product_transformation_output_id", nullable = false, updatable = false)
    private Long id;
