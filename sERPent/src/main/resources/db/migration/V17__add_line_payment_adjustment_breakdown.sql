-- V17__add_line_payment_adjustment_breakdown.sql
...
-- pre-existing data.
--
-- Not to be confused with the sale-wide manual adjustment on `sales` (V15): that is one
-- figure for the whole sale, this is per line.
--
-- NOTE: this file must stay identical in effect to
-- db/migration-h2/V6__add_line_payment_adjustment_breakdown.sql
